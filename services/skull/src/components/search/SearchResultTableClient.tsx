...
type SearchResultTableClientProps = {
...
function buildPageHref(params: { q: string; page: number; size: number }) {
...
export default function SearchResultTableClient({
    items,
    page,
    size,
    total,
    q,
}: SearchResultTableClientProps) {
                ...
                <table className="min-w-full border-collapse text-sm">
                    <thead className="bg-gray-50">
                        <tr className="text-left">
                            ...
                            <th className="border-b px-4 py-3">sync</th>
