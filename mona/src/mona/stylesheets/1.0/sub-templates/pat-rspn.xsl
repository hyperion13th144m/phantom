...
<xsl:stylesheet version="3.0"
        ...
        <xsl:element name="blocks">
            ...
            <xsl:choose>
                <xsl:when test="parent::jp:submission-date">
                    <xsl:element name="jpTag">【提出日】</xsl:element>
                    <xsl:element name="indentLevel">
                        <xsl:value-of select="0" />
                    </xsl:element>
                </xsl:when>
                <xsl:when test="parent::jp:dispatch-date">
                    <xsl:element name="jpTag">【発送日】</xsl:element>
                    <xsl:element name="indentLevel">
                        <xsl:value-of select="0" />
                    </xsl:element>
                </xsl:when>
                <xsl:when test="parent::jp:priority-claim">
                    <xsl:element name="jpTag">【出願日】</xsl:element>
                    <xsl:element name="indentLevel">
                        <xsl:value-of select="2" />
                    </xsl:element>
                </xsl:when>
                <xsl:when test="parent::jp:appeal-reference">
                    <xsl:element name="jpTag">【審判請求日】</xsl:element>
                    <xsl:element name="indentLevel">
                        <xsl:value-of select="2" />
                    </xsl:element>
                </xsl:when>
    ...
    <!-- ====================================================================
         元: pat_common.xsl 文書番号編集, 文書番号内容編集
         ====================================================================-->
        ...
        <xsl:element name="blocks">
            ...
            <xsl:element name="convertedText">
                <xsl:call-template name="translate-application-number">
                    ...
                    <xsl:with-param name="law" select="$app-ref-law" />
    ...
    <!-- ====================================================================
         ...
         ====================================================================-->
    <xsl:template
        match="jp:application-reference [@appl-type = 'examined-pub']//jp:doc-number">
        <xsl:variable name="app-ref-law" select="ancestor::jp:application-reference/@jp:kind-of-law" />
        <xsl:element name="blocks">
            <xsl:element name="tag">
                <xsl:value-of select="name()" />
            ...
            <xsl:element name="convertedText">
                <xsl:call-template name="translate-examined-pub-number">
                    <xsl:with-param name="number" select="normalize-space()" />
                    <xsl:with-param name="law" select="$app-ref-law" />
                </xsl:call-template>
            </xsl:element>
    ...
    <!-- ====================================================================
         ...
         ====================================================================-->
    <xsl:template
        match="jp:application-reference [@appl-type = 'un-examined-pub']//jp:doc-number">
        <xsl:variable name="app-ref-law" select="ancestor::jp:application-reference/@jp:kind-of-law" />
        <xsl:element name="blocks">
            <xsl:element name="tag">
                <xsl:value-of select="name()" />
    ...
    <xsl:template
        ...
        <xsl:element name="blocks">
            ...
            <xsl:element name="indentLevel">
                <xsl:value-of
                    select="key('tags-table-key-1', local-name(), $tags-table-1)/@indent-level" />
            </xsl:element>
        </xsl:element>
    </xsl:template>
    ...
    <xsl:variable name="tags-table-1">
        <item tag="representative-applicant" value="【代表出願人】" indent-level="2" />
        <item tag="office-address" value="【就業場所】" indent-level="2" />
        <item tag="attorney" value="【弁理士】" indent-level="2" />
        <item tag="lawyer" value="【弁護士】" indent-level="2" />
    </xsl:variable>
    ...
    <xsl:template
        ...
        <xsl:element name="blocks">
            ...
            <xsl:element name="indentLevel">
                <xsl:value-of
                    select="key('tags-table-key-2', local-name(), $tags-table-2)/@indent-level" />
            </xsl:element>
        </xsl:element>
    </xsl:template>
    ...
    <xsl:variable name="tags-table-2">
        <item tag="dispatch-number" value="【発送番号】" indent-level="0" />
        <item tag="general-power-of-attorney-id" value="【包括委任状番号】" indent-level="2" />
        <item tag="receipt-number" value="【受付番号】" indent-level="2" />
        <item tag="citation" value="【援用の表示】" indent-level="3" />
        <item tag="law-of-industrial-regenerate" value="【国等の委託研究の成果に係る記載事項】" indent-level="0" />
        <item tag="relation-attorney-special-matter" value="【代理関係の特記事項】" indent-level="2" />
        <item tag="contact" value="【連絡先】" indent-level="2" />
        <item tag="fax" value="【ファクシミリ番号】" indent-level="2" />
        <item tag="phone" value="【電話番号】" indent-level="2" />
        <item tag="legal-entity-property" value="【法人の法的性質】" indent-level="2" />
        <item tag="office" value="【営業所】" indent-level="2" />
        <item tag="office-in-japan" value="【日本における営業所】" indent-level="2" />
        <item tag="trust-relation" value="【信託関係事項】" indent-level="0" />
        <item tag="name" value="【氏名又は名称】" indent-level="2" />
        <item tag="kana" value="【フリガナ】" indent-level="2" />
        <item tag="text" value="【住所又は居所】" indent-level="2" />
